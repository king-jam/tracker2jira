...
type DeleteProjectByIDURL struct {
	ProjectID string
...
func (o *DeleteProjectByIDURL) Build() (*url.URL, error) {
	...
	if projectID != "" {
		...
		return nil, errors.New("ProjectID is required on DeleteProjectByIDURL")
	}
...
func (o *DeleteProjectByIDURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on DeleteProjectByIDURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on DeleteProjectByIDURL")
	}
