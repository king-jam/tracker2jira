...
// GetProjectByIDParams contains all the bound params for the get project by ID operation
...
//
// To ensure default values, the struct must have been initialized with NewGetProjectByIDParams() beforehand.
...
func (o *GetProjectByIDParams) bindProjectID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
